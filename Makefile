...
docs-check: ## Check Markdown formatting
	uv run mdformat --check README.md CONVENTIONS.md $$(find docs -name "*.md" ! -path "docs/issues/TEMPLATE.md")
